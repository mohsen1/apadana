  ...
  <Html>
    ...
    <Body className='bg-white font-sans'>
      <Container className='mx-auto py-5 pb-12 max-w-lg'>
        <Heading className='text-2xl font-bold text-gray-700 my-10'>New Booking Request</Heading>
        ...
        <Section className='my-4 p-4 bg-gray-50 rounded'>
          ...
          <Text className='text-base text-gray-700 leading-6 my-3'>Number of guests: {guests}</Text>
          <Text className='text-base text-gray-700 leading-6 my-3'>
