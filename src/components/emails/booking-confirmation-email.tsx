      ...
      <Tailwind>
        <Body className='bg-white'>
          <Container className='mx-auto px-4 py-8'>
            <Heading className='text-2xl font-bold text-gray-900'>Booking Confirmed!</Heading>
            <Text className='mt-4 text-gray-700'>Hi {guestName},</Text>
            ...
            <Text className='mt-6 text-gray-700'>
              We hope you enjoy your stay! If you need to contact your host, you can do so through
              the Apadana messaging system.
            </Text>
          </Container>
        </Body>
      </Tailwind>
