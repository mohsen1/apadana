    ...
    <div className='flex flex-col min-h-screen'>
      <header className='px-4 lg:px-6 h-14 flex items-center'>
        <Link className='flex items-center justify-center' href='#'>
          ...
          <span className='sr-only'>Make Your Own Listing Inc</span>
        </Link>
            ...
            <div className='flex flex-col items-center space-y-4 text-center'>
              <div className='space-y-2'>
                ...
                <p className='mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400'>
                  ...
                  Get direct bookings, manage your calendar, and communicate
                  with guests - all without extra fees.
                </p>
              </div>
          ...
          <div className='container px-4 md:px-6'>
            ...
            <div className='grid gap-6 lg:grid-cols-3'>
              <Card>
                ...
                <CardContent>
                  Easily manage your listing's availability and sync with other
