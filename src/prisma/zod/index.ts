...
export const PasswordResetScalarFieldEnumSchema = z.enum(['id','userId','token','expiresAt']);
...
export const ListingSchema = z.object({
  ...
  latitude: z.number().gt(-90, { message: "Latitude must be greater than -90" }).lt(90, { message: "Latitude must be less than 90" }).nullable(),
  longitude: z.number().int({ message: "Longitude must be a number" }).min(-180, { message: "Longitude must be greater than -180" }).max(180, { message: "Longitude must be less than 180" }).nullable(),
...
.and(z.object({
  ...
  latitude: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number().gt(-90, { message: "Latitude must be greater than -90" }).lt(90, { message: "Latitude must be less than 90" }) ]).optional().nullable(),
  longitude: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number().int({ message: "Longitude must be a number" }).min(-180, { message: "Longitude must be greater than -180" }).max(180, { message: "Longitude must be less than 180" }) ]).optional().nullable(),
...
export const ListingCreateInputSchema: z.ZodType<Prisma.ListingCreateInput> = z.object({
  ...
  propertyType: z.string({required_error: "Property type is required" }),
  address: z.string({required_error: "Address is required" }),
  latitude: z.number().gt(-90, { message: "Latitude must be greater than -90" }).lt(90, { message: "Latitude must be less than 90" }).optional().nullable(),
  longitude: z.number().int({ message: "Longitude must be a number" }).min(-180, { message: "Longitude must be greater than -180" }).max(180, { message: "Longitude must be less than 180" }).optional().nullable(),
...
export const ListingUpdateInputSchema: z.ZodType<Prisma.ListingUpdateInput> = z.object({
  ...
  latitude: z.union([ z.number().gt(-90, { message: "Latitude must be greater than -90" }).lt(90, { message: "Latitude must be less than 90" }),z.lazy(() => NullableFloatFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  longitude: z.union([ z.number().int({ message: "Longitude must be a number" }).min(-180, { message: "Longitude must be greater than -180" }).max(180, { message: "Longitude must be less than 180" }),z.lazy(() => NullableFloatFieldUpdateOperationsInputSchema) ]).optional().nullable(),
